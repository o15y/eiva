export declare type Entity = EntityNumber | EntityUnknown | EntityPerson | EntityLocation | EntityOrganization | EntityEvent | EntityWorkOfArt | EntityConsumerGood | EntityOther | EntityPhoneNumber | EntityAddress | EntityDate | EntityNumber | EntityPrice;
...
export declare const detectEntities: (text: string) => Promise<{
    language: string;
    entities: Entity[];
