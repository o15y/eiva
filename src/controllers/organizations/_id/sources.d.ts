...
export declare class OrganizationSourcesController {
    getSources(req: Request, res: Response): Promise<any>;
    putSources(req: Request, res: Response): Promise<{
        code: number;
        success: boolean;
        message: string;
        text: string | undefined;
    }>;
    getSource(req: Request, res: Response): Promise<import("stripe").Stripe.CustomerSource>;
    patchSource(req: Request, res: Response): Promise<{
        updated: {
            success: boolean;
            message: string;
        };
    ...
    deleteSource(req: Request, res: Response): Promise<{
        code: number;
        success: boolean;
        message: string;
        text: string | undefined;
