...
export declare class OrganizationBillingController {
    getBilling(req: Request, res: Response): Promise<import("stripe").Stripe.Customer | import("stripe").Stripe.DeletedCustomer>;
    patchBilling(req: Request, res: Response): Promise<{
        success: boolean;
        message: string;
    }>;
    getPlans(req: Request, res: Response): Promise<import("stripe").Stripe.ApiList<import("stripe").Stripe.Plan>>;
}
