...
export declare class OrganizationTransactionsController {
    getTransactions(req: Request, res: Response): Promise<import("stripe").Stripe.ApiList<import("stripe").Stripe.CustomerBalanceTransaction>>;
    applyCoupon(req: Request, res: Response): Promise<import("stripe").Stripe.CustomerBalanceTransaction>;
    getTransaction(req: Request, res: Response): Promise<import("stripe").Stripe.CustomerBalanceTransaction>;
}
